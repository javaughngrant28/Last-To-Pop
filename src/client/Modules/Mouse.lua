...
- GetPosition(), GetTarget(), and Raycast(Q) are all useful, but unsecure and would not be consistent in a real game; it is useful for debugging and small projects, though 
